...
def main(config):
    ...
    for e in range(epochs):
        ...
        dev_loss_per_epoch, dev_r2_loss_per_epoch = evaluate_model(model, dev_dataloader, loss_fn, mode)
    ...
    test_loss_per_epoch, test_r2_loss_per_epoch = evaluate_model(best_model, test_dataloader, loss_fn, mode)
    print(
