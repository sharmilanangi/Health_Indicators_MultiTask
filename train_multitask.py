...
BEST_MODEL_FILE = f"outputs/best_multitask_full_data.pth"
WRITER_PATH = f"logdir/multitask_best_full_data"
epochs = 100
lr = 1e-4
batch_size = 256
...
class MultiTaskNet(nn.Module):
    def __init__(self, embed_dim=11348, layer_sizes=[11333, 500, 11348, 500]):
        super().__init__()
